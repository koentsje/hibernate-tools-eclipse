package org.hibernate.tool.eclipse.orm.common.core.test.utils;

import org.eclipse.osgi.util.NLS;

public class TestConsoleMessages extends NLS {
	private static final String BUNDLE_NAME = "org.hibernate.tool.eclipse.orm.common.core.test.utils.ConsoleTestMessages"; //$NON-NLS-1$
