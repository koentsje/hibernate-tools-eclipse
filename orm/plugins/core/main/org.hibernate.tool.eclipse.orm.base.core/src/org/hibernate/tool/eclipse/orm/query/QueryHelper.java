...
public class QueryHelper {
	...
	public static String generateSQL(final ISessionFactory sessionFactory, final String query, final IService service) {

		if(query == null || query.isEmpty()) return ""; //$NON-NLS-1$
