...
public class HibernateEclipseUtils {
	...
	public static boolean isJpaFacetInstalled(IProject project) {
		try {
			...
			Platform.getLog(HibernateEclipseUtils.class).log(new Status(IStatus.ERROR, "org.hibernate.tool.eclipse.orm.base.core", e.getMessage(), e));
			return false;
		}
	}
	...
	public static String getConnectionProfileName(IProject project) {
		try {
			...
			Platform.getLog(HibernateEclipseUtils.class).log(new Status(IStatus.ERROR, "org.hibernate.tool.eclipse.orm.base.core", ex.getMessage(), ex));
			return null;
		}
	}
