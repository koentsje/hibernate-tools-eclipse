...
public class HibernateConsoleCorePlugin extends Plugin {

	public static final String ID = "org.hibernate.eclipse.console"; //$NON-NLS-1$

	private static HibernateConsoleCorePlugin plugin;

	public HibernateConsoleCorePlugin() {
		super();
		setPlugin(this);
	}
	...
	private static void setPlugin(HibernateConsoleCorePlugin plugin) {
		HibernateConsoleCorePlugin.plugin = plugin;
	}
