 ...
 */
package org.hibernate.tool.eclipse.orm.console.core.eclipse.nature;
...
import org.hibernate.tool.eclipse.orm.base.core.builder.HibernateBuilder;
...
public class HibernateNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		//HibernateConsoleCorePlugin.getDefault().log("Configuring " + project + " as a Hibernate project");
	...
	public void deconfigure() throws CoreException {
		//HibernateConsoleCorePlugin.getDefault().log("Deconfiguring " + project + " as a Hibernate project");
	}
	...
	public class ReadDatabaseMetaData extends Job {
		...
		protected IStatus run(IProgressMonitor monitor) {
			...
			try {
				...
				return new Status(IStatus.ERROR, HibernateConsoleCorePlugin.ID, 1, HibernateConsoleMessages.HibernateNature_error_while_performing_background_reading_of_database_schema, t);
			}
		}
	...
	public static HibernateNature getHibernateNature(IJavaProject project) {
		try {
			...
			HibernateConsoleCorePlugin.getDefault().logErrorMessage( HibernateConsoleMessages.HibernateNature_exception_when_trying_to_locate_hibernate_nature, e );
		}
		return null;
	}
