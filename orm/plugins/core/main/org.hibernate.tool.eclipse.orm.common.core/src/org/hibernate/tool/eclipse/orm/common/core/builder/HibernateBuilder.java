 ...
 */
package org.hibernate.tool.eclipse.orm.common.core.builder;
...
public class HibernateBuilder extends IncrementalProjectBuilder {
	...
	public static final String BUILDER_ID = HibernateConsoleCorePlugin.ID + ".hibernateBuilder"; //$NON-NLS-1$
