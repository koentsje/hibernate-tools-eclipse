package org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal;
...
import org.hibernate.tool.eclipse.orm.runtime.legacy.AbstractService;
...
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.ConfigurationMetadataDescriptor;
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.DummyMetadataBuildingContext;
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.DummyMetadataDescriptor;
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.JdbcMetadataConfiguration;
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.JpaConfiguration;
import org.hibernate.tool.eclipse.orm.runtime.v_5_6.internal.util.JpaMappingFileHelper;
        ...
        try {
			...
			try {
				...
				if (clazz != null) {
					...
					throw new HibernateRuntimeException("Class " + className + " could not be found.");
				}
			}
			catch (Exception eq) {
