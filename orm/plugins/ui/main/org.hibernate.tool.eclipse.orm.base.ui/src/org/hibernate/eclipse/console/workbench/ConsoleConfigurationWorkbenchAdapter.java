...
public class ConsoleConfigurationWorkbenchAdapter extends BasicWorkbenchAdapter {
	...
	public Object[] getChildren(Object o) {		
		...
		if(configuration!=null) {
			...
			o1 = Messages.ConsoleConfigurationWorkbenchAdapter_empty_configuration;
		}
	...
	protected String getDefaultErrorMessage(Object object) {
		return NLS.bind(Messages.BasicWorkbenchAdapter_error_while_opening_configuration, getLabel(object));
	}
}
