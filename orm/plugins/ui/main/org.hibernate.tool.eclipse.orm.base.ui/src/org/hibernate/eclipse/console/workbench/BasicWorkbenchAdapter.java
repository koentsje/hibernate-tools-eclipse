...
public abstract class BasicWorkbenchAdapter implements IDeferredWorkbenchAdapter {
	...
	protected String getDefaultErrorMessage(Object object) {
		...
		return NLS.bind(BasicHibernateMessages.BasicWorkbenchAdapter_error_while_expanding, getLabel(object));
	}


	protected String getDefaultErrorTitle() {
		return BasicHibernateMessages.BasicWorkbenchAdapter_hibernate_configuration_error;
	}
