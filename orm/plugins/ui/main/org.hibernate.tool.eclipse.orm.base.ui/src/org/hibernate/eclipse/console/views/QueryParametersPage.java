...
public class QueryParametersPage extends Page implements IQueryParametersPage {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if(statusLabel!=null) {
					...
					if(firstElement instanceof QueryParameter) {
						statusLabel.setText(Messages.QueryParametersPage_format + ((QueryParameter)firstElement).getDefaultFormat());
					} else {
	...
	private class NewRowAction extends Action {
		public NewRowAction() {
			super( "" ); //$NON-NLS-1$
			setToolTipText(Messages.QueryParametersPage_add_query_parameter_tooltip);
...
/*			if(cqp==null) {
	...
	private class RemoveRowAction extends Action {
		public RemoveRowAction() {
			super( "" ); //$NON-NLS-1$
			setToolTipText(Messages.QueryParametersPage_remove_query_parameter_tooltip);
	...
	private class ToggleActive extends Action {
		public ToggleActive() {
			super(""); //$NON-NLS-1$
			setToolTipText(Messages.QueryParametersPage_enable_disable_parameters_tooltip);
			setChecked(false);
