...
public class CriteriaEditorInput extends QueryEditorInput {
    ...
    public void resetName() {
    	setName( BasicHibernateMessages.CriteriaEditorInput_criteria + (getConsoleConfigurationName()==null?BasicHibernateMessages.CriteriaEditorInput_none:getConsoleConfigurationName()) );
    }
}
