...
public class HibernateConsolePerspectiveFactory implements IPerspectiveFactory {
	...
	static public final String ID_CONSOLE_PERSPECTIVE = "org.hibernate.tool.eclipse.orm.base.ui.console.HibernateConsolePerspective"; //$NON-NLS-1$
	//	Folders
	private static final String ID_CONFIGURATION_VIEW = "org.hibernate.tool.eclipse.orm.base.ui.console.views.KnownConfigurationsView"; //$NON-NLS-1$
	private static final String ID_QUERYRESULTS_VIEW = "org.hibernate.tool.eclipse.orm.base.ui.console.views.QueryPageTabView"; //$NON-NLS-1$
	private static final String ID_PROPERTY_SHEET_VIEW = "org.eclipse.ui.views.PropertySheet"; //$NON-NLS-1$
	private static final String ID_DYNAMIC_QUERY_TRANSLATOR_VIEW = "org.hibernate.tool.eclipse.orm.base.ui.console.views.DynamicSQLPreviewView"; //$NON-NLS-1$
	...
	private static final String ID_QUERY_PARAMETERS = "org.hibernate.tool.eclipse.orm.base.ui.console.views.QueryParametersView"; //$NON-NLS-1$
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		//HibernateBasePlugin.getDefault().openScratchHQLEditor(null);
	}
