 ...
 */
package org.hibernate.tool.eclipse.orm.help.ui;
	...
	public ResourceBundle getResourceBundle() {
		try {
			if (resourceBundle == null)
				resourceBundle = ResourceBundle.getBundle("org.hibernate.tool.eclipse.orm.help.ui.HelpPluginResources"); //$NON-NLS-1$
