 ...
 */
package org.hibernate.tool.eclipse.orm.xml.ui.mapper.editors;
...
import org.hibernate.tool.eclipse.orm.xml.ui.mapper.editors.reveng.RevEngTablesPage;
import org.hibernate.tool.eclipse.orm.xml.ui.mapper.editors.reveng.RevEngTypeMappingPage;
import org.hibernate.tool.eclipse.orm.xml.ui.mapper.editors.xpl.XMLFormEditorPart;
...
public class ReverseEngineeringEditor extends XMLFormEditorPart {
	...
	public LazyDatabaseSchema getLazyDatabaseSchema() {
		try {
			...
			IService service = configuration.getRuntimeManager().getHibernateService();
